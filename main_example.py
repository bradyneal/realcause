...
gen_model.plot_ty_dists(n_samples_per_z=10, save_name='test_svi')

gen_model2 = DataGenModel(df, linear_gaussian_model, svi=False, mcmc='nuts')
gen_model2.plot_ty_dists(n_samples_per_z=10, save_name='test_nuts')
