...
zdim = 5
(z, t, y) = generate_zty_linear_multi_z_data(100, zdim=zdim, delta=5)
gen_model = DataGenModel((z, t, y), linear_multi_z_outcome_model, AutoNormal, lr=.03, n_iters=1500)
print('Expected ATE: 5\t Actual: ', gen_model.get_ate())
